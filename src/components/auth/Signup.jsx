  ...
  return (
    <>
      <div className="max-w-md mx-auto mt-20 sm:mt-28 p-4 sm:p-6 bg-white/95 rounded-xl shadow-lg ring-1 ring-black/5">
        ...
        <form onSubmit={onSignup} className="space-y-3 sm:space-y-4 text-gray-600">
          ...
          {/* Terms + Agreement */}
          <div className="rounded-lg border text-coffee-700 border-gray-200 p-2.5 sm:p-3 bg-gray-50">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-2xl rounded-xl bg-white shadow-xl max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 border-b flex-shrink-0">
              <h2 className="text-base sm:text-lg font-semibold text-coffee-800">Terms of Service & Privacy Policy</h2>
              <button
            ...
            <div
              ...
              className="text-coffee-700 px-4 sm:px-5 py-3 sm:py-4 overflow-y-auto prose prose-sm prose-gray flex-1"
            >
              <p className="text-sm">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-3 px-4 sm:px-5 py-3 sm:py-4 border-t flex-shrink-0">
              <span className={`text-xs sm:text-sm text-center sm:text-left ${termsScrolledToEnd ? "text-green-700" : "text-gray-600"}`}>
                {termsScrolledToEnd ? "You reached the end." : "Scroll to the end to enable confirmation."}
              </span>
              <div className="flex gap-2">
                <button
                  onClick={() => setTermsOpen(false)}
                  className="flex-1 sm:flex-none px-4 py-2 rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 text-sm"
                >
                  Cancel
                </button>
                <button
                  ...
                  className={`flex-1 sm:flex-none px-4 py-2 rounded-lg text-white font-medium transition text-sm
